...
See <https://uralstech.github.io/UCloud.Operations/DocSource/QuickStart.html> or `APIReferenceManual.pdf` in the package documentation for the reference manual.